    ...
    &__menu {
        ...
        &-item {
            & a {
                ...
                font-size: 18px;
                &:hover {
                    border-bottom: 3px solid #283044;
                    padding: 0 0 3px 0;
                }
            }
        }
...
.btn {
    ...
    box-shadow: 0 -3px rgb(101, 160, 238) inset;
    transition: 0.2s;
    &:hover {
        background: rgb(101, 160, 238);
    }
    &:active {
        background: rgb(89, 165, 216);
        box-shadow: 0 3px rgb(89, 165, 216) inset;
    }
    &.primary {
        background-color: rgb(83, 75, 98);
        box-shadow: 0 -3px rgb(83, 65, 106) inset;
        &:hover {
            background: rgb(83, 65, 106);
        }
        &:active {
            background: rgb(83, 75, 98);
            box-shadow: 0 3px rgb(83, 75, 98) inset;
        }
    }
    &.danger {
    ...
    &.warning {
        background-color: rgb(163, 75, 193);
        box-shadow: 0 -3px rgb(156, 67, 203) inset;
        &:hover {
            background: rgb(156, 67, 203);
        }
        &:active {
            background: rgb(163, 75, 193);
            box-shadow: 0 3px rgb(163, 75, 193) inset;
        }
    }
    &.normal {
        background-color: rgb(33, 209, 159);
        box-shadow: 0 -3px rgb(33, 193, 159) inset;
        &:hover {
            background: rgb(33, 193, 159);
        }
        &:active {
            background: rgb(33, 209, 159);
            box-shadow: 0 3px rgb(33, 209, 159) inset;
        }
    }
    &.like {
